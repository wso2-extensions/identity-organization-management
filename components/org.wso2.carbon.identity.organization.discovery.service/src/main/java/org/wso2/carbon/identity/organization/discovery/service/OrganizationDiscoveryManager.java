...
public interface OrganizationDiscoveryManager {
     ...
     * @param validateParentOrgAccess Determines whether validation is required for parent organization access.
    ...
    List<OrgDiscoveryAttribute> addOrganizationDiscoveryAttributes(String organizationId, List<OrgDiscoveryAttribute>
            discoveryAttributes, boolean validateParentOrgAccess) throws OrganizationManagementException;

    /**
     * Fetch the discovery attributes of the organization.
     *
     * @param organizationId            The organization ID.
     * @param validateAncestorOrgAccess Determines whether validation is required for ancestor organization access.
    ...
    List<OrgDiscoveryAttribute> getOrganizationDiscoveryAttributes(String organizationId,
                                                                   boolean validateAncestorOrgAccess)
     ...
     *                                         organization.
     */
    void deleteOrganizationDiscoveryAttributes(String organizationId, boolean validateParentOrgAccess)
            throws OrganizationManagementException;
