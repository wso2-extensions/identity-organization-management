...
public class ResourceSharingPolicyHandlerServiceImplTest {
    ...
    @Test(expectedExceptions = ResourceSharingPolicyMgtClientException.class, priority = 6)
    public void testGetResourceSharingPolicies_null_failure() throws Exception {
...
//    }
    ...
    @Test(expectedExceptions = ResourceSharingPolicyMgtClientException.class, priority = 17)
    ...
    @Test(expectedExceptions = ResourceSharingPolicyMgtClientException.class, priority = 20)
