...
DROP INDEX IF EXISTS CONSTRAINT_INDEX_95;
DROP INDEX IF EXISTS PRIMARY_KEY_95;
...
(
    ...
    CONSTRAINT CONSTRAINT_95 PRIMARY KEY (UM_ID),
    CONSTRAINT CONSTRAINT_957 FOREIGN KEY (UM_PARENT_ID) REFERENCES PUBLIC.UM_ORG (UM_ID) ON DELETE CASCADE ON UPDATE RESTRICT
);
CREATE INDEX CONSTRAINT_INDEX_95 ON PUBLIC.UM_ORG (UM_PARENT_ID);
CREATE UNIQUE INDEX PRIMARY_KEY_95 ON PUBLIC.UM_ORG (UM_ID);
...
VALUES
    ('USER', 'a07a3509-f646-498c-890e-cedb08cd1586', '10084a8d-113f-4211-a0d5-efe36b082211', 'c524c30a-cbd4-4169-ac9d-1ee3edf1bf16', 'SEL-EF-0003'),
    ('USER', '678afe66-36ed-4c0a-8789-b6f83c4f40dc', '10084a8d-113f-4211-a0d5-efe36b082211', 'c524c30a-cbd4-4169-ac9d-1ee3edf1bf16', 'SEL-EF-0003'),
    ('USER', '150b7b05-21bb-4b20-a7be-9e7a299969bb', '10084a8d-113f-4211-a0d5-efe36b082211', '7cb4ab7e-9a25-44bd-a9e0-cf4e07d804dc', 'SEL-EF-0005'),
    ('USER', '94154a9a-e177-404c-8504-d58a71db1f84', '10084a8d-113f-4211-a0d5-efe36b082211', 'c524c30a-cbd4-4169-ac9d-1ee3edf1bf16', 'SEL-EF-0003'),
    ('USER', '94154a9a-e177-404c-8504-d58a71db1f84', '10084a8d-113f-4211-a0d5-efe36b082211', 'c524c30a-cbd4-4169-ac9d-1ee3edf1bf16', 'SEL-EF-0005');
