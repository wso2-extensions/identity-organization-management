...
public enum ResourceType {
    ...
    IDP(Collections.emptyList()),
    IDENTITY_VERIFICATION_PROVIDER(Collections.emptyList()),
    CUSTOM_AUTHENTICATOR(Collections.emptyList()),
    FLOW_EXTENSION(Collections.emptyList());
