...
package org.wso2.carbon.identity.organization.management.organization.connection.sharing.internal.constant;
...
public class ConnectionSharingSQLConstants {
    ...
    public static final String COLUMN_NAME_SHARED_CONNECTION_UUID = "SHARED_CONNECTION_UUID";
    ...
    public static final String INSERT_CONNECTION_ASSOCIATION =
            "INSERT INTO IDN_ORG_CONNECTION_ASSOCIATION (CONNECTION_TYPE, ASSOCIATED_CONNECTION_UUID, " +
                    "ASSOCIATED_ORG_ID, SHARED_CONNECTION_UUID, SHARED_ORG_ID) VALUES (:CONNECTION_TYPE;, " +
                    ":ASSOCIATED_CONNECTION_UUID;, :ASSOCIATED_ORG_ID;, :SHARED_CONNECTION_UUID;, :SHARED_ORG_ID;)";

    public static final String GET_SHARED_CONNECTION_ID =
            "SELECT SHARED_CONNECTION_UUID FROM IDN_ORG_CONNECTION_ASSOCIATION WHERE " +
                    "CONNECTION_TYPE = :CONNECTION_TYPE; AND " +
    ...
    public static final String GET_CONNECTION_ASSOCIATION_BY_SHARED_RESOURCE =
            "SELECT ID, CONNECTION_TYPE, ASSOCIATED_CONNECTION_UUID, ASSOCIATED_ORG_ID, SHARED_CONNECTION_UUID, " +
                    "SHARED_ORG_ID FROM IDN_ORG_CONNECTION_ASSOCIATION WHERE CONNECTION_TYPE = :CONNECTION_TYPE; AND " +
                    "SHARED_CONNECTION_UUID = :SHARED_CONNECTION_UUID;";
    ...
    public static final String DELETE_CONNECTION_ASSOCIATION_IN_ORG =
            "DELETE FROM IDN_ORG_CONNECTION_ASSOCIATION WHERE CONNECTION_TYPE = :CONNECTION_TYPE; AND " +
