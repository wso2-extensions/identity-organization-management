...
public class ConnectionSharingSQLConstants {
    ...
    public static final String COLUMN_NAME_ASSOCIATED_RESOURCE_UUID = "ASSOCIATED_RESOURCE_UUID";
    ...
    public static final String INSERT_CONNECTION_ASSOCIATION =
            "INSERT INTO IDN_ORG_CONNECTION_ASSOCIATION (RESOURCE_TYPE, ASSOCIATED_RESOURCE_UUID, " +
                    "ASSOCIATED_ORG_ID, SHARED_RESOURCE_UUID, SHARED_ORG_ID) VALUES (:RESOURCE_TYPE;, " +
                    ":ASSOCIATED_RESOURCE_UUID;, :ASSOCIATED_ORG_ID;, :SHARED_RESOURCE_UUID;, :SHARED_ORG_ID;)";

    public static final String GET_SHARED_CONNECTION_ID =
            "SELECT SHARED_RESOURCE_UUID FROM IDN_ORG_CONNECTION_ASSOCIATION WHERE " +
                    "RESOURCE_TYPE = :RESOURCE_TYPE; AND ASSOCIATED_RESOURCE_UUID = :ASSOCIATED_RESOURCE_UUID; AND " +
    ...
    public static final String GET_CONNECTION_ASSOCIATION_BY_SHARED_RESOURCE =
            "SELECT ID, RESOURCE_TYPE, ASSOCIATED_RESOURCE_UUID, ASSOCIATED_ORG_ID, SHARED_RESOURCE_UUID, " +
    ...
    // Selects every association whose original (parent) connection resides in the given organization, i.e. the
    // connections that organization owns and has shared down its hierarchy.
