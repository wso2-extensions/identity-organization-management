...
public class RoleManagementConstants {
    ...
    public enum ErrorMessages {
        ...
        ERROR_CODE_INVALID_PAGINATION_PARAMETER_NEGATIVE_LIMIT("ORM-65014",
                "Invalid pagination parameters.", "The 'limit' should be positive."),
        ERROR_CODE_ERROR_BUILDING_PAGINATED_RESPONSE_URL("ORM-65016", "Unable to retrieve the roles.",
                "Server encountered an error while building paginated response URL."),
        ERROR_CODE_INVALID_ORGANIZATION("ORM-65017", "Invalid organization.",
                "Organization with ID: %s doesn't exist."),
        ERROR_CODE_ROLE_NAME_ALREADY_EXISTS("ORM-65018", "Role name already exists.",
                "Role already exists for the role name: %s"),
