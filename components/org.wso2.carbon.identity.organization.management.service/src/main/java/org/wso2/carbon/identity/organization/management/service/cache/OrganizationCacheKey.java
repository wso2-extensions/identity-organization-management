...
/**
 * Abstract representation of the organization cache key.
 */
public abstract class OrganizationCacheKey extends CacheKey {

    private final String organizationKey;

    OrganizationCacheKey(String organizationKey) {
