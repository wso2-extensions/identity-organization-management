...
public class OrganizationManagementConstants {
    ...
    public enum ErrorMessages {
        ...
        ERROR_CODE_ROLE_DISPLAY_NAME_NOT_NULL("60038", "Role name cannot be null",
        ...
        ERROR_CODE_ROLE_NAME_OR_ID_REQUIRED("60041", "Role name or id is required.",
                "Role name or id is required to check whether the role exists in organization %s."),
        ERROR_CODE_REMOVE_OP_VALUES("ORM-60213", "Remove patch operation values are passed with the path.",
        ...
        ERROR_CODE_GETTING_USERS_USING_ROLE_ID("65035", "Error getting users.",
                "Server encountered an error while retrieving user(s) from role id %s."),
        ERROR_CODE_GETTING_GROUPS_USING_ROLE_ID("65036", "Error getting users of role Id.",
                "Server encountered an error while retrieving user(s) from role id %s."),
        ERROR_CODE_GETTING_PERMISSIONS_USING_ROLE_ID("65037", "Error getting permissions for the role.",
                "Server encountered an error while retrieving permission(s) from role id %s."),
        ERROR_CODE_GETTING_ROLES_FROM_ORGANIZATION("65038", "Error getting roles from organization.",
                "Server encountered an error while retrieving role(s) from organization %s."),
        ERROR_CODE_PATCHING_ROLE("65039", "Error patching a role from organization.",
                "Server encountered an error while patching a role in the organization %s."),
        ERROR_CODE_REMOVING_USERS_FROM_ROLE("65040", "Error removing a user from role.",
                "Server encountered an error while removing users from the role %s."),
        ERROR_CODE_REMOVING_GROUPS_FROM_ROLE("65041", "Error removing a group from role.",
                "Server encountered an error while removing groups from the role %s."),
        ERROR_CODE_REMOVING_PERMISSIONS_FROM_ROLE("65042", "Error removing a permission from role.",
                "Server encountered an error while removing permissions from the role %s."),
        ERROR_CODE_REMOVING_ROLE_FROM_ORGANIZATION("65043", "Error removing a role from an organization.",
                "Server encountered an error while removing a role %s from organization %s."),
        ERROR_CODE_REPLACING_DISPLAY_NAME_OF_ROLE("65044", "Error replacing display name of role.",
                "Server encountered an error while replacing the display name %s of role %s."),
        ERROR_CODE_GETTING_PERMISSION_IDS_USING_PERMISSION_STRING("65045",
                "Error getting permission ids using resource id.",
                "Server encountered an error while retrieving the permission ids."),
        ERROR_CODE_GETTING_ROLE_FROM_ORGANIZATION_ID_ROLE_NAME("65046",
        ...
        ERROR_CODE_GETTING_ROLE_FROM_ORGANIZATION_ID_ROLE_ID("65047",
        ...
        ERROR_CODE_GETTING_USER_VALIDITY("65048", "Error getting user from user id.",
                "Server encountered an error while retrieving a user %s."),
        ERROR_CODE_GETTING_GROUP_VALIDITY("65049", "Error getting group from group id.",
                "Server encountered an error while retrieving a group %s."),
        ERROR_CODE_ERROR_BUILDING_ROLE_URI("65050", "Unable to build create role URI.",
