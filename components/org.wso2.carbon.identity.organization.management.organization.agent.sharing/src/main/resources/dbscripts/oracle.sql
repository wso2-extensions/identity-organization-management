...
CREATE TABLE UM_ORG_AGENT_ASSOCIATION (
    UM_ID                  NUMBER(10)    NOT NULL,
    UM_AGENT_ID            VARCHAR2(255) NOT NULL,
    UM_ORG_ID              VARCHAR2(36)  NOT NULL,
    UM_ASSOCIATED_AGENT_ID VARCHAR2(255) NOT NULL,
    UM_ASSOCIATED_ORG_ID   VARCHAR2(36)  NOT NULL,
    UM_SHARED_TYPE         VARCHAR2(100),
    PRIMARY KEY (UM_ID),
...
CREATE SEQUENCE UM_ORG_AGENT_ASSOCIATION_SEQ START WITH 1 INCREMENT BY 1 NOCACHE
/

CREATE OR REPLACE TRIGGER UM_ORG_AGENT_ASSOC_TRIG
    BEFORE INSERT ON UM_ORG_AGENT_ASSOCIATION
    FOR EACH ROW
    BEGIN
        SELECT UM_ORG_AGENT_ASSOCIATION_SEQ.NEXTVAL INTO :NEW.UM_ID FROM DUAL;
    END;
/
