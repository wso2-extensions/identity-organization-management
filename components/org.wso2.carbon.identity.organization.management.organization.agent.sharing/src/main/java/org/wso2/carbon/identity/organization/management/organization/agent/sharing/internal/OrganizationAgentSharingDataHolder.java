...
/**
 * Data holder for organization agent sharing management.
 */
public class OrganizationAgentSharingDataHolder {

    private static final OrganizationAgentSharingDataHolder instance = new OrganizationAgentSharingDataHolder();
    private RealmService realmService;
    private OrganizationManager organizationManager;
    private RoleManagementService roleManagementService;
    private OrganizationAgentSharingService organizationAgentSharingService;
    ...
    private OrganizationAgentSharingDataHolder() {

    }

    public static OrganizationAgentSharingDataHolder getInstance() {
    ...
    /**
     * Get the organization agent sharing service.
     *
     * @return OrganizationAgentSharingService organization agent sharing service.
     */
    public OrganizationAgentSharingService getOrganizationAgentSharingService() {

        return organizationAgentSharingService;
    }

    /**
     * Set the organization agent sharing service.
     *
     * @param organizationAgentSharingService Organization agent sharing service.
     */
    public void setOrganizationAgentSharingService(OrganizationAgentSharingService organizationAgentSharingService) {

        this.organizationAgentSharingService = organizationAgentSharingService;
    }
