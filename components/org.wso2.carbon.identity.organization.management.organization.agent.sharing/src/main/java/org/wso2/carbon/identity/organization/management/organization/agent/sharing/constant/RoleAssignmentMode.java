...
/**
 * Enum representing the modes of role assignments for agent sharing.
 */
    ...
    public static RoleAssignmentMode fromString(String stringValueOfRoleAssignmentMode) {
        ...
        if (stringValueOfRoleAssignmentMode == null || stringValueOfRoleAssignmentMode.trim().isEmpty()) {
            throw new IllegalArgumentException(
                    "RoleAssignmentMode value cannot be null or empty. Valid modes are: " + VALID_MODES);
        }
        ...
        throw new IllegalArgumentException("Invalid RoleAssignmentMode value: " +
                stringValueOfRoleAssignmentMode.trim() + ". Valid modes are: " + VALID_MODES);
    }
}
