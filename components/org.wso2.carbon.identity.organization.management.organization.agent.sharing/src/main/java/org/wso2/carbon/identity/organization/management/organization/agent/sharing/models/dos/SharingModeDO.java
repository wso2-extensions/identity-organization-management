...
/**
 * Data object that represents the agent sharing mode configuration, including the sharing policy and the
...
public class SharingModeDO {
    ...
    public void setRoleAssignment(RoleAssignmentDO roleAssignment) {
