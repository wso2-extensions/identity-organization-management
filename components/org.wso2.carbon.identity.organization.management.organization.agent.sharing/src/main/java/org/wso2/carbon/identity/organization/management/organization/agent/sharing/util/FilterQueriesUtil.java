...
import static org.wso2.carbon.identity.organization.management.organization.agent.sharing.constant.AgentSharingConstants.SHARED_AGENT_SHARED_ATTRIBUTE_COLUMN_MAP;
...
/**
 * Utility class for working with filter queries in conjunction with the {@link FilterQueryBuilder} for agent sharing.
 */
public class FilterQueriesUtil {

    /**
     * Get the filter query builder for shared agent organizations.
     *
     ...
     */
    public static FilterQueryBuilder getSharedAgentOrgsFilterQueryBuilder(List<ExpressionNode> expressionNodes)
            throws OrganizationManagementClientException {

        return getFilterQueryBuilder(expressionNodes, SHARED_AGENT_SHARED_ATTRIBUTE_COLUMN_MAP::get);
    }
