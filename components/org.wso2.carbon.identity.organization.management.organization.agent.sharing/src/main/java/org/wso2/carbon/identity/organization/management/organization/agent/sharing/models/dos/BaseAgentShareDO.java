...
/**
 * Abstract class for common properties and methods for agent share data objects.
 *
 * @param <T> The type of agent criteria used in the agent sharing operations.
 */
public abstract class BaseAgentShareDO<T extends AgentCriteriaType> {
