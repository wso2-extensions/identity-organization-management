...
import static org.wso2.carbon.identity.organization.config.service.constant.OrganizationConfigConstants.PARAMETER_MAPPINGS;
        ...
        try {
            ...
            for (ConfigProperty configProperty : configProperties) {
                if (DEFAULT_PARAM.equals(configProperty.getKey())
                    ...
                    return PARAMETER_MAPPINGS.get(configProperty.getValue());
                }
            }
        } catch (OrganizationConfigException e) {
            if (ERROR_CODE_DISCOVERY_CONFIG_NOT_EXIST.getCode().equals(e.getErrorCode())) {
                return PARAMETER_MAPPINGS.get(getOrganizationDiscoveryDefaultParam());
            }
