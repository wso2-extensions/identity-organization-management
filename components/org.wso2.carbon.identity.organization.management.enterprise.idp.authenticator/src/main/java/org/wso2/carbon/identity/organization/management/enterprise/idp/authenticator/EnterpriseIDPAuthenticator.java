...
package org.wso2.carbon.identity.organization.management.enterprise.idp.authenticator;
...
import org.wso2.carbon.identity.organization.management.enterprise.idp.authenticator.internal.EnterpriseIDPAuthenticatorDataHolder;
import org.wso2.carbon.identity.organization.management.enterprise.login.mgt.core.exceptions.EnterpriseLoginManagementException;
...
import static org.wso2.carbon.identity.organization.management.enterprise.idp.authenticator.EnterpriseIDPAuthenticatorConstants.ACCOUNT_CHOOSE_PROMPT_PAGE;
import static org.wso2.carbon.identity.organization.management.enterprise.idp.authenticator.EnterpriseIDPAuthenticatorConstants.AUTHORIZATION_ENDPOINT_TENANTED_PATH;
import static org.wso2.carbon.identity.organization.management.enterprise.idp.authenticator.EnterpriseIDPAuthenticatorConstants.EMAIL_DOMAIN_SEPARATOR;
import static org.wso2.carbon.identity.organization.management.enterprise.idp.authenticator.EnterpriseIDPAuthenticatorConstants.ORGANIZATION_ATTRIBUTE;
import static org.wso2.carbon.identity.organization.management.enterprise.idp.authenticator.EnterpriseIDPAuthenticatorConstants.ORGANIZATION_USER_ATTRIBUTE;
import static org.wso2.carbon.identity.organization.management.enterprise.idp.authenticator.EnterpriseIDPAuthenticatorConstants.ORG_PARAMETER;
import static org.wso2.carbon.identity.organization.management.enterprise.idp.authenticator.EnterpriseIDPAuthenticatorConstants.TENANT_PLACEHOLDER;
import static org.wso2.carbon.identity.organization.management.enterprise.idp.authenticator.EnterpriseIDPAuthenticatorConstants.TOKEN_ENDPOINT_TENANTED_PATH;
import static org.wso2.carbon.identity.organization.management.enterprise.idp.authenticator.EnterpriseIDPAuthenticatorConstants.USERINFO_ENDPOINT_TENANTED_PATH;
import static org.wso2.carbon.identity.organization.management.enterprise.idp.authenticator.EnterpriseIDPAuthenticatorConstants.USERNAME_PARAMETER;
import static org.wso2.carbon.identity.organization.management.enterprise.idp.authenticator.util.EnterpriseIDPErrorConstants.ErrorMessages.EMAIL_DOMAIN_IS_NOT_REGISTERED_FOR_ENTERPRISE_IDP_LOGIN;
import static org.wso2.carbon.identity.organization.management.enterprise.idp.authenticator.util.EnterpriseIDPErrorConstants.ErrorMessages.EMAIL_DOMAIN_NOT_ASSOCIATED;
import static org.wso2.carbon.identity.organization.management.enterprise.idp.authenticator.util.EnterpriseIDPErrorConstants.ErrorMessages.ENTERPRISE_IDP_LOGIN_FAILED;
import static org.wso2.carbon.identity.organization.management.enterprise.idp.authenticator.util.EnterpriseIDPErrorConstants.ErrorMessages.ORG_NOT_FOUND;
import static org.wso2.carbon.identity.organization.management.enterprise.idp.authenticator.util.EnterpriseIDPErrorConstants.ErrorMessages.USERNAME_IS_NOT_AN_EMAIL_ERROR;
import static org.wso2.carbon.identity.organization.management.enterprise.idp.authenticator.util.EnterpriseIDPErrorConstants.ErrorMessages.USERNAME_PARAMETER_NOT_FOUND;
