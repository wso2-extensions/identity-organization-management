...
import org.wso2.carbon.identity.organization.management.enterprise.idp.authenticator.EnterpriseIDPAuthenticator;
 ...
 */
@Component(
        name = "org.wso2.carbon.identity.org.mgt.enterprise.idp.authenticator.component",
        immediate = true
)
public class EnterpriseIDPAuthenticatorServiceComponent {
    ...
    @Reference(name = "org.wso2.carbon.identity.org.mgt.enterprise.login.mgt.core.component",
