...
package org.wso2.carbon.identity.organization.user.invitation.management.util;
...
/**
 * Util methods needed for testing.
 */
public class TestUtils {

    public static final String DB_NAME = "testOrgUserInvitationMgt_db";
