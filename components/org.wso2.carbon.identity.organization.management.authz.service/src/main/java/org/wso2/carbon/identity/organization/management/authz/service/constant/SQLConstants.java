...
public class SQLConstants {
    ...
    public static final String GET_AUTHORIZED_ORGANIZATIONS = "SELECT ORG_ID FROM UM_USER_ROLE_ORG WHERE UM_USER_ID = :"
            + DB_SCHEMA_COLUMN_USER_ID + "; AND UM_TENANT_ID = :" + DB_SCHEMA_COLUMN_NAME_TENANT_ID +
            "; AND UM_HYBRID_ROLE_ID IN (SELECT UM_ID FROM UM_HYBRID_ROLE WHERE UM_ROLE_NAME IN (SELECT UM_ROLE_NAME " +
