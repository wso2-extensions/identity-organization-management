...
public class AuthorizationConstants {
    ...
    public static final String REGEX_FOR_URLS_WITH_ORG_ID_WITH_ROLES =
            "^(.)*(/api/identity/organization-mgt/v1.0/organizations/)(.)*(/roles)$";
    public static final String REGEX_FOR_URLS_WITH_ORG_ID_WITH_USERS =
            "^(.)*(/api/identity/organization-mgt/v1.0/organizations/)(.)*(/users)$";
    public static final String REGEX_FOR_URLS_WITH_ORG_ID_WITH_USERS_AND_ROLES =
            "^(.)*(/api/identity/organization-mgt/v1.0/organizations/)(.)*(/roles/)(.)*(/users/)(.)*$";
