...
(
    ...
    UM_POLICY_TYPE      VARCHAR(100) NOT NULL,
...
-- Resource-level governance policy table
...
-- Selected orgs for SELECTED-type resource policies
...
(
    ...
    UM_ALLOW_OVERRIDE BOOLEAN      NOT NULL,
    PRIMARY KEY (UM_ID),
    CONSTRAINT FK_RES_GOV_POLICY FOREIGN KEY (UM_POLICY_ID)
        REFERENCES UM_RESOURCE_GOVERNANCE_POLICY (UM_ID) ON DELETE CASCADE,
    UNIQUE (UM_POLICY_ID, UM_TARGET_ORG_ID)
);
