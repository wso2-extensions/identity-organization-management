...
public class OrganizationCreationHandler extends AbstractEventHandler {
    ...
    private void addSharedApplicationsToOrganization(Organization organization)
        ...
        // Get the roleMode
        // Get parent org shared Roles, if the mode is not none (Which is available on the attribute table, it has the main role IDs, so get associations with the parent org.
