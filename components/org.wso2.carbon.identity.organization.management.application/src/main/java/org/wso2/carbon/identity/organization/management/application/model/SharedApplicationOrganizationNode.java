...
public class SharedApplicationOrganizationNode {
    ...
    public SharedApplicationOrganizationNode(String organizationId, String organizationName, List<RoleWithAudienceDO>
            roleWithAudienceDOList, boolean hasChildren, int depthFromRoot) {
