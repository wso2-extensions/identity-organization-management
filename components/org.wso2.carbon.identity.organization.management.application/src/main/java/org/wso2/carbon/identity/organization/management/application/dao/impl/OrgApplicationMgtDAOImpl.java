...
import static org.wso2.carbon.identity.organization.management.service.constant.OrganizationManagementConstants.ErrorMessages.ERROR_CODE_CHECKING_APPLICATION_HAS_FRAGMENTS;
...
public class OrgApplicationMgtDAOImpl implements OrgApplicationMgtDAO {
    ...
    public boolean hasFragments(String applicationId) throws OrganizationManagementException {
        ...
        try {
            ...
            throw handleServerException(ERROR_CODE_CHECKING_APPLICATION_HAS_FRAGMENTS, e, applicationId);
        }
    }
}
